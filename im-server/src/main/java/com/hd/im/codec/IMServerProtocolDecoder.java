...
import com.hd.im.commons.constants.ErrorResult;
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf byteBuf, List<Object> list) throws Exception {
        if (byteBuf.readableBytes() > 0) {
            ...
            if (op == HDIMProtocol.HeadType.LOGIN.getNumber()) {
                ...
                String decrypt = null;
                try {
                    decrypt = AESHelper.decrypt(dst, session.get().getAesKey());
                ...
                try {
                    publish = HDIMProtocol.Publish.parseFrom(decrypt.getBytes("utf-8"));
                } catch (Exception e) {
